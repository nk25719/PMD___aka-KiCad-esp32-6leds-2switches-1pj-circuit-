// Modified for ESP32 and on Homework2 PWA.
// Pulse sensor on GPIO33
...
/*
   Pinout:
     ...
     THRESHOLD should be set higher than the PulseSensor signal idles
      ...
      Adjust as neccesary.
*/
//const int PULSE_INPUT = A0;  // UNO
const int PULSE_INPUT = 33;   //ESP32 on Homework.
//const int PULSE_BLINK = LED_BUILTIN;
const int PULSE_BLINK = 2; // Built in on ESP32
//const int PULSE_FADE = 5;
const int PULSE_FADE = 15;  // Homework assembly
//const int THRESHOLD = 550;   // Adjust this number to avoid noise when idle
//const int THRESHOLD = 550*4096/1024 ;   // For ESP32 12 bit ADC. Adjust this number to avoid noise when idle
//const int THRESHOLD = 1850;   // For ESP32 12 bit ADC. Adjust this number to avoid noise when idle
const int THRESHOLD = 1825;   // For ESP32 12 bit ADC. Adjust this number to avoid noise when idle
